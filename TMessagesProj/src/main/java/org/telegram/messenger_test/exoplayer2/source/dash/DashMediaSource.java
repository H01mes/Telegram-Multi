...
import org.telegram.messenger_test.exoplayer2.ParserException;
import org.telegram.messenger_test.exoplayer2.Timeline;
import org.telegram.messenger_test.exoplayer2.source.AdaptiveMediaSourceEventListener;
import org.telegram.messenger_test.exoplayer2.source.AdaptiveMediaSourceEventListener.EventDispatcher;
import org.telegram.messenger_test.exoplayer2.source.MediaPeriod;
...
import org.telegram.messenger_test.exoplayer2.source.dash.manifest.DashManifestParser;
import org.telegram.messenger_test.exoplayer2.source.dash.manifest.UtcTimingElement;
...
import org.telegram.messenger_test.exoplayer2.upstream.ParsingLoadable;
...
public final class DashMediaSource implements MediaSource {
  ...
  private static final class PeriodSeekInfo {
    ...
    public static PeriodSeekInfo createPeriodSeekInfo(
            org.telegram.messenger_test.exoplayer2.source.dash.manifest.Period period, long durationUs) {
  ...
  private static final class DashTimeline extends Timeline {
    ...
    private long getAdjustedWindowDefaultStartPositionUs(long defaultPositionProjectionUs) {
      ...
      org.telegram.messenger_test.exoplayer2.source.dash.manifest.Period period =
