...
package org.telegram.messenger_test.camera;
...
public class CameraView extends FrameLayout implements TextureView.SurfaceTextureListener {
    ...
    private void initCamera(boolean front) {
        ...
        org.telegram.messenger_test.camera.Size aspectRatio;
        int wantedWidth;
        int wantedHeight;
        ...
        org.telegram.messenger_test.camera.Size pictureSize = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedWidth, wantedHeight, aspectRatio);
        if (pictureSize.getWidth() >= 1280 && pictureSize.getHeight() >= 1280) {
            ...
            org.telegram.messenger_test.camera.Size pictureSize2 = CameraController.chooseOptimalSize(info.getPictureSizes(), wantedHeight, wantedWidth, aspectRatio);
